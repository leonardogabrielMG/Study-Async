...
def iniciar_desafio(request):
    if request.method == "GET":
        ...
        print(f"Quantidade de cards: {flashcards.count()}\nQuantidade de perguntas: {qtd_perguntas}")
        
        if flashcards.count() < int(qtd_perguntas):
            messages.add_message(request, constants.ERROR, "Quantidade de cards cadastrados insuficientes!")
...
def listar_desafio(request):
    ...
    return render(
        request,'listar_desafio.html',{'desafios': desafios,},
    )
